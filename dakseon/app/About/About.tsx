...
const About: React.FC = () => {
  return (
    <div className={styles.aboutContainer}>
      ...
      <h1>About Dakseon</h1>
      <p className={styles.p}>At Dakseon, we are committed to providing high-quality mobility and safety products that help individuals live with greater independence and confidence.</p>
